            ...
            <div className="flex flex-col h-full justify-between">
                ...
                <div>
                    ...
                    <p
                        ...
                        style={{ fontSize: "clamp(1.2rem, 1.8vw, 3rem)" }}
                    >
                ...
                {weather && (
                    <div
                        className="mt-6 flex items-center backdrop-blur-md rounded-md bg-white/15 border-2 border-white/10 w-max"
                        style={{
                            gap: "clamp(0.75rem, 1vw, 1.5rem)",
                            padding: "clamp(0.75rem, 1vw, 1.5rem)",
                        }}
                    >
                        <span style={{ fontSize: "clamp(3rem, 5vw, 7rem)" }}>
                            {weather.icon}
                        </span>
                        <div>
                            <p
