    ...
    return (
        ...
        >
            <div
                ...
                style={{ marginBottom: "clamp(0.5rem, 1.5vh, 2rem)" }}
            >
                <h3
                    className="text-white font-bold font-archia"
            ...
            <div
                ...
                style={{ gap: "clamp(0.5rem, 1vh, 1.5rem)" }}
            >
                {announcements.map((announcement, index) => (
                    ...
                    >
                        <h4
                            className="font-archia font-semibold text-white"
                            style={{ fontSize: "clamp(1.5rem, 2.8vw, 4rem)" }}
                        >
                            {announcement.title}
                        </h4>
                        <p
                            className="text-white font-archia"
                            style={{ fontSize: "clamp(1.5rem, 2.8vw, 4rem)" }}
                        >
